    ...
    <>
      ...
      <div id="frame1">
        <div id="aside">
          <div id="sections">
            <img
              src="images/store/4brickkatalog.png"
              id="sectionsimg"
              alt="sections"
            />
            <div id="sectionstext">Разделы</div>
            <div id="sectionstext1">
              <a href="https://steamcommunity.com/id/moi_gospodin/">Steam</a>
            </div>
          ...
          <div id="categories">
            <img
              src="images/store/6brickskatalog.png"
              id="categoriesimg"
              alt="categories"
            />
        ...
        <div id="pgswitch">
          <a href="https://www.youtube.com/watch?v=_S7WEVLbQ-Y&ab_channel=FicLord">
            <div id="nextpg"></div>
          </a>
          <a href="https://www.youtube.com/watch?v=esbKmlkIi2w&ab_channel=RobenSikk">
            <div id="previouspg"></div>
          </a>
        </div>
      </div>
        ...
        <div id="footer_wrapper">
          <div id="footer">
            <div className="sub_content">
              <p>
                Все права защищены. Копирование любых материалов сайта
                запрещено! Все названия продуктов и игр, компаний и марок,
                логотипы, товарные знаки и другие материалы являются
                собственностью соответствующих владельцев. Только лицензионные
                ключи ко всем игровым платформам: Steam, Uplay, Battle.net,
                Origin и другие. Выгодно, надежно и быстро!
              </p>
            </div>
          </div>
